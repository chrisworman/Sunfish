...
namespace Sunfish.Views
{
	public class Line : View
	{
			...
			base (Constants.ViewLayer.Layer1)
		{
			...
			WhitePixel = SunfishGame.ActiveScreen.LoadTexture ("WhitePixel");
		}
		...
		{	
			...
			SunfishGame.ActiveSpriteBatch.Draw(WhitePixel, r, null, OverlayColor, angle, Vector2.Zero, SpriteEffects.None, 0);
		}
